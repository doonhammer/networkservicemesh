...
docker-build: docker-build-netmesh-test docker-build-netmesh docker-build-nsm-init docker-build-nse docker-build-simple-dataplane docker-build-sidecar-dataplane

# Individual targets are found in .nsm.mk
docker-push: docker-login docker-push-netmesh docker-push-simple-dataplane docker-push-sidecar-dataplane docker-push-nsm-init docker-push-nse
